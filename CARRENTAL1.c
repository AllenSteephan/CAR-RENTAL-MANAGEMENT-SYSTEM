...
char carmodel[10][20]={"verna","Celerio","Civic","corola altis","Eco sport","Safari","E63 AMG0","Q3","D-MAX"};
int carseat[10]={4,4,4,8,4,4,4,8,8,0};
int carrentperday[10]={500,450,400,550,550,450,850,850,6150,0};
...
void display()
{
    ...
    printf("################################################ \n");
    printf("#     HYUNDAI    #  Verna   #      500         # \n");
    printf("#     SUZUKI     #  Celerio #      450         # \n");
    printf("#      HONDA     #  Civic   #      400         # \n");
    printf("#     TOYOTA     #  corola  #      550         # \n");
    printf("#      FORD      # Ecosport #      550         # \n");
    printf("#      TATA      #  Safari  #      450         # \n");
    printf("#    MERCEDES    #  E63 AMG #      850         # \n");
    printf("#      AUDI      #  Q3      #      850         # \n");
    printf("#     ISUZU      #  D-MAX   #      650         # \n");
    printf("################################################ \n");
}
int main()
{
